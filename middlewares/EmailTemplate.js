export const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} MLSA@KIET. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
...
export const Welcome_Email_Template = `
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Welcome to MLSA Community</title>
      <style>
          body {
              font-family: Arial, sans-serif;
              margin: 0;
  ...
  <body>
      <div class="container">
          <div class="header">Welcome to MLSA Community!</div>
          <div class="content">
              ...
              <a href="https://mlsa-kiet.vercel.app" class="button">Get Started</a>
